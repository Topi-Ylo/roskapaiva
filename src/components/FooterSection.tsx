    ...
    <section id="mukaan" className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-32 md:py-40">
        ...
        <div className="mt-20 grid gap-px bg-cream/10 md:grid-cols-3">
          <div className="reveal delay-2 bg-forest-night/80 p-10 md:p-12">
            ...
            <a href={settings.instagram_url ?? 'https://instagram.com/roskapaiva'} className="mt-8 inline-flex items-center gap-2 text-cream transition hover:text-amber">
          ...
          <div className="reveal delay-3 bg-forest-night/80 p-10 md:p-12">
            ...
            <p className="mt-8 font-display text-xl text-cream/60">Tarkemmat tiedot tulossa.</p>
          </div>

          <div className="reveal delay-4 bg-forest-night/80 p-10 md:p-12">
            ...
            <p className="mt-8 font-display text-xl text-cream/60">Kun se aukeaa.</p>
          </div>
        </div>
        ...
        <div className="reveal mt-24 grid gap-12 border-t border-cream/15 pt-16 md:grid-cols-12">
          ...
          <div className="md:col-span-5 md:text-right">
            ...
            <div className="mt-6 flex gap-4 md:justify-end">
              <a href="#" aria-label="Instagram" className="ghost-cta flex h-14 w-14 items-center justify-center rounded-full text-cream">
              ...
              <a href="#" aria-label="TikTok" className="ghost-cta flex h-14 w-14 items-center justify-center rounded-full text-cream">
              ...
              <a href="#" aria-label="YouTube" className="ghost-cta flex h-14 w-14 items-center justify-center rounded-full text-cream">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
